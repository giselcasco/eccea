...
import (
	boiling "eccea/internal/brewbeer/processes/fermentation"
...
func (_m *ServiceMock) Do(params *fermentation.Params, useCaseKey string) (*fermentation.Results, error) {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*fermentation.Params, string) error); ok {
